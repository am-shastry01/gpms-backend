...
public class GatePassRequestController {
    ...
    public Page<GatePassResponse> list(
        ...
        return gatePassRequestService.list(query, status, warehouseId, fromDate, toDate, page, size);
    }
    ...
    public AttachmentResponse addAttachment(@PathVariable UUID id, @RequestPart("file") MultipartFile file) {
